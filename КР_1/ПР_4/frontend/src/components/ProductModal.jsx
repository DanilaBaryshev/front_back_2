...
export default function ProductModal({ open, mode, initialProduct, onClose, onSubmit }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (!Number.isFinite(parsedPrice) || parsedPrice < 0)     { alert('Введите корректную цену (≥ 0)');          return; }
    if (!Number.isFinite(parsedStock) || parsedStock < 0)     { alert('Введите корректное количество на складе'); return; }
